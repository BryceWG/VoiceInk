...
from PyQt6.QtCore import (Qt, QTimer, QPropertyAnimation, QEasingCurve, 
                         pyqtProperty, QRectF)
from PyQt6.QtGui import QPainter, QColor, QLinearGradient, QPen  # 添加 QPen 导入
import numpy as np

class WaveVisualizerWindow(QWidget):
    def __init__(self, config_manager):
        super().__init__()
        self.setAttribute(Qt.WidgetAttribute.WA_TranslucentBackground)  # 添加这行
        ...
        self.background_color = QColor(255, 255, 255)  # 不透明白色背景
        self.border_color = QColor(52, 152, 219)  # 蓝色边框
    ...
    def showEvent(self, event):
        ...
        QTimer.singleShot(10, self.play_ripple_animation)  # 延迟一小段时间再播放动画
